...
# 3DGCN model
class GCN3_GLOBAL(torch.nn.Module):
    def __init__(self, n_output=1, n_filters=32, num_features_xd=78,  output_dim=128, dropout=0.1):#num_features_xt=25

        super(GCN3_GLOBAL, self).__init__()
    ...
    def forward(self, data):
        ...
        conv_xt = self.conv_xt_1(target)  # 512*(32*4)*128
